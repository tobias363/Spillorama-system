...
public sealed class Theme1GameplayViewRoot : MonoBehaviour
{
    ...
    public void EnsurePresentationInitialized()
    {
        ...
        RefreshVisibleContractFromScene();
    ...
    private void RefreshVisibleContractFromScene()
    {
        NumberGenerator generator = UnityEngine.Object.FindFirstObjectByType<NumberGenerator>(FindObjectsInactive.Include);
        BallManager resolvedBallManager = UnityEngine.Object.FindFirstObjectByType<BallManager>(FindObjectsInactive.Include);
        GameManager gameManager = GameManager.instance != null
            ? GameManager.instance
            : UnityEngine.Object.FindFirstObjectByType<GameManager>(FindObjectsInactive.Include);
        TopperManager topperManager = UnityEngine.Object.FindFirstObjectByType<TopperManager>(FindObjectsInactive.Include);
        CandyCardViewBindingSet cardBindings = UnityEngine.Object.FindFirstObjectByType<CandyCardViewBindingSet>(FindObjectsInactive.Include);
        CandyBallViewBindingSet ballBindings = UnityEngine.Object.FindFirstObjectByType<CandyBallViewBindingSet>(FindObjectsInactive.Include);
        CandyTheme1HudBindingSet hudBindings = UnityEngine.Object.FindFirstObjectByType<CandyTheme1HudBindingSet>(FindObjectsInactive.Include);
        ...
        if (generator?.cardClasses != null && generator.cardClasses.Length > 0)
        {
            ...
            cards = new Theme1CardGridView[cardCount];
    ...
    private static bool NeedsCardBindingBootstrap(NumberGenerator generator)
    {
        ...
        for (int cardIndex = 0; cardIndex < generator.cardClasses.Length; cardIndex++)
        {
            ...
            if (card == null ||
                ...
                card.num_text.Count < Theme1CardCellCount ||
                card.selectionImg.Count < Theme1CardCellCount ||
                card.missingPatternImg.Count < Theme1CardCellCount ||
                card.matchPatternImg.Count < Theme1CardCellCount)
            {
                return true;
            }

            for (int cellIndex = 0; cellIndex < Theme1CardCellCount; cellIndex++)
            {
