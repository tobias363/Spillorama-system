...
| Krav | Verdi |
|---|---|
| Minimum celebration | `MIN_CELEBRATION_MS = 6_000` (6 sek) |
...
- ❌ Senk `MIN_CELEBRATION_MS` under 6s uten Tobias-godkjennelse. Tobias har eksplisitt sagt 6s er nedre grense for komfortabel celebrasjon.
