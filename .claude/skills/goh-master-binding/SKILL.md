...
### 4-hall GoH full-plan baseline (2026-05-16)

Kanonisk lokal evidence for pilot-GoH:

- Command: `node scripts/dev/goh-full-plan-run.mjs --players-per-hall=20 --connect-delay-ms=2200 --join-delay-ms=60 --purchase-concurrency=8 --round-timeout-ms=900000`
- Scope: `demo-pilot-goh`, 4 haller x 20 spillere = 80 samtidige testspillere.
- Result: clean run PASSED, alle 13 Spill 1-planposisjoner completed.
- Final plan-run: `status=finished`, `current_position=13`.
