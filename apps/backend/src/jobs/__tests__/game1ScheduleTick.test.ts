/**
 * GAME1_SCHEDULE PR 1+2+3: tests for the JobScheduler-integration wrapper.
 *
 * Verifies:
 *   - Job calls all five service methods in sequence (PR2 added
 *     transitionReadyToStartGames; PR3 added detectMasterTimeout).
