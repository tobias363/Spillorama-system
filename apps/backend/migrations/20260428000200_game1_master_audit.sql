...
-- compliance-rapporter skal være reproducerbare. Begge tabellene skrives
-- i samme transaksjon fra Game1MasterControlService så data holdes i sync.
--
-- Designvalg:
...
--   * `actor_hall_id` TEXT NOT NULL — hallen actor jobber fra (master-hall
--     for start/pause/resume/stop; hall-operator/admin som kaller exclude).
--     Ikke FK fordi vi vil bevare audit selv om hall slettes.
