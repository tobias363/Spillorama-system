# ADR-0014 — Idempotente migrasjoner — CREATE TABLE IF NOT EXISTS før ALTER (MED-2)

**Status:** Accepted
**Dato:** 2026-05-06
**Deciders:** Tobias Haugen (MED-2 fix-runde)
**Konsulterer:** —

> **Migrering 2026-05-08:** Migrert fra `docs/decisions/ADR-012-idempotent-migrations.md` til ny struktur. Innhold uendret.
...
- Lint kan fange ALTER-før-CREATE-bugs i fremtiden — se Operasjonelt under.

## Alternativer vurdert

### Alternativ A: Rename `20260425` til `20260725` (etter CREATE)
Avvist:
...
### Alternativ B: Slett 20260425-filen og inline endringene i 20260724
Avvist:
...
### Alternativ C: Skriv en separat "fix-up"-migrasjon (ny timestamp etter 20260724)
Avvist:
- Løser ikke fersh-DB-problemet — 20260425 ville fortsatt feile før fix-en kjører.

### Alternativ D: Gjør 20260425 helt tom (`-- noop on prod`) og inline ALTER inn i 20260724
Avvist:
...
### Operasjonelt — for framtidige migrasjoner
...
- [ ] Kommentar i migrasjons-filen som peker til ADR-0014 og forklarer mønsteret.

Skills som bør oppdateres: `database-migration-policy`.
