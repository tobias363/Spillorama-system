...
Antall skills totalt: **25** — varsel hvis noen mangler scope-header:
...
| `pm-orchestration-pattern` | 14 | 33 | `BACKLOG.md`<br>`docs/operations/PM_HANDOFF_*.md`<br>`docs/operations/PM_KNOWLEDGE_CONTINUITY_V2.md`<br>`docs/engineering/PM_*.md`<br>_(+10 more)_ |
