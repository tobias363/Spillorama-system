...
import {
  ...
  isLocalhostUrl,
  isRunningLocally,
  resolveHostnameFromBaseUrl,
  normalizeSession,
  readStoredSession,
  writeSession,
  readPortalAuthAccessToken,
  canAutoCreateRoom,
  shouldRedirectTheme1ToPortalOnLiveHost,
  canonicalizeTheme1LiveSession,
  resolveTheme1PortalUrl,
  redirectTheme1ToPortal,
  resolveTheme1LiveConnectionErrorMessage,
  readLaunchTokenFromLocation,
  clearLaunchTokenFromLocation,
  resolveLaunchBaseUrl,
  readInitialSessionSeed,
  ...
  DEFAULT_CANDY_HALL_ID,
  DEFAULT_CANDY_ROOM_CODE,
  THEME1_RECOVERABLE_SYNC_ERROR_CODES,
} from "@/features/theme1/hooks/theme1Session";
...
// Session functions moved to theme1Session.ts
...
// Session functions (readInitialSessionSeed, resolveTheme1InitialSessionSeed,
// readPortalAuthAccessToken, readStoredSession, writeSession, normalizeSession,
// canAutoCreateRoom, shouldAttemptLiveRoomRecoveryFromSyncFailure) moved to
// theme1Session.ts
...
// Re-export session functions for consumers that import from useTheme1Store
export {
  type Theme1AccessTokenSource,
  isLocalTheme1RuntimeHost,
  shouldRedirectTheme1ToPortalOnLiveHost,
